...
function verifyIfExistsAccountCPF(req, res, next){
    ...
    if (!customer) return res.status(400).json({ error : "Customer don't exists!" })
...
app.get("/statement/date", verifyIfExistsAccountCPF, (req, res) => {
    ...
    const statement = customer.statement.filter((statement) => statement.created.toDateString() === new Date(dateFormat).toDateString())
